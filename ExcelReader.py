...
Mainly, this will be used for Union Pacific documentation sent in CFA format.
...
class ExcelReader:
    ...
    # This includes both italics and the strike-through, which is typical formatting from UP.
